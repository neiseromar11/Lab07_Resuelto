...
public class PantallaGerente extends javax.swing.JFrame {
    ...
    public PantallaGerente() {
     ...
     public PantallaGerente(ArrayList<Persona>personas){
     initComponents();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
      ...
      geren.setCargo(txtCargo.getText());
      geren.setNombre(txtNombre.getText());
      geren.setApellido(txtApellido.getText());
      personas.add(geren);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaGerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
